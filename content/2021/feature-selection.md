...
![table compiled as an answer key, listing burst-length patterns, burst values, start indices, and their corresponding numeric labels]({static}/images/burst_pattern_answer_key_table.png)
...
![a yellow triangle rendered on a black background, decoded from the mystery input sequence]({static}/images/decoded_yellow_triangle_image.png)
